...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'dice.wast';
  var wasmBinaryFile = 'dice.wasm';
  var asmjsCodeFile = 'dice.temp.asm.js';
...
var real__dice_roll = asm["_dice_roll"]; asm["_dice_roll"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__dice_roll.apply(null, arguments);
};
...
var real__random_color = asm["_random_color"]; asm["_random_color"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__random_color.apply(null, arguments);
};
...
var _dice_roll = Module["_dice_roll"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_dice_roll"].apply(null, arguments) };
...
var _random_color = Module["_random_color"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_random_color"].apply(null, arguments) };
